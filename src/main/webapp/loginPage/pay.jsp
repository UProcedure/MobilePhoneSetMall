...
<div class="concent">
   ...
   <div class="paycont" style="position: ">
       <h3>确认收货地址 </h3>
           <div class="tc-btn createAddr theme-login am-btn am-btn-danger"><a href="loginPage/addAddress.jsp" style="color: darkred;">使用新地址</a></div>
       <div class="address">
            <div class="clear"></div>
            ...
            <div class="order-go clearfix">
                <div class="pay-confirm clearfix">
                    <div class="box">
                        ...
                        <fmt:formatNumber value="${shopCart.pirce}" pattern="0.00" ></fmt:formatNumber>
                                </em>
                    </span>
                    ...
                    <div id="holyshit269" class="submitOrder" style="background: #f5f5f5">
                        ...
                        <form action="goods/success" method="post" id="form">
