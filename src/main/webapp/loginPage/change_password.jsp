...
<div class="toper">
    <div class="top">
        ...
        <div class="top_ewm">
            <div><img src="uploadfiles/ewm_03.jpg" width="59" height="59" /></div>天猫商城
        </div>
        <div class="mainnav">
            <ul>
...
<div class="login">
    <div class="login_dl">
        <h1 class="h1" style="width: 500px"><a href="javascript:;" class="a">&nbsp;修&nbsp;改&nbsp;密&nbsp;码</a></h1>
        <h3 class="h3"></h3>
        <dl>
            <dt>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="90" align="right">旧密码</td>
                        <td><input type="password" class="text" id="oldPassword" name="oldPassword"/><span></span></td>
                    </tr>
                    <form action="user/updatePassword/${user.id}" method="post" id="update">

                        <tr>
                            <td width="90" align="right">新密码</td>
                            <td><input type="password" class="text" name="newPassword" id="newPassword"/><span></span></td>
                        </tr>
                    </form>
                    <tr>
                        <td width="90" align="right">请确认新密码</td>
                        <td><input type="password" class="text"  id="newPassword2"/><span></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="90"></td>
                        <td ><input type="button" class="btn" id="change_password"  style="color: #0b3a58" /></td>
                    </tr>
                </table>
            </dt>
    ...
    $(function () {
        ...
        $("#oldPassword").blur(function () {
            ...
            if(oldPassword == null || oldPassword == ""){
                $("#oldPassword+span").html("<font color='red'>&nbsp; &nbsp; &nbsp; 旧密码不能为空</font>");
                isOldPsw = false;
            }
            $.ajax({
                ...
                success:function (data) {
                    if(data){
                        $("#oldPassword+span").html("ok");
                        isOldPsw = true;
                    }else {
                        $("#oldPassword+span").html("<font color='red'>&nbsp; &nbsp; &nbsp; 密码错误</font>");
                        isOldPsw = false;
                    }
                }
            })
        ...
        $("#newPassword").blur(function(){
            ...
            if(value1 == ""){
                $("#newPassword+span").html("<font color='red'>&nbsp; &nbsp; &nbsp; 密码不能为空</font>");
                isPsw1 = false;
            }else{
                $("#newPassword+span").html("ok");
                isPsw1 = true;
            }
        })

        $("#newPassword2").blur(function(){
            var value1 = $("#newPassword").val().trim();
            var value2 = $(this).val().trim();
            if(value2 == ""){
                $("#newPassword2+span").html("<font color='red'>&nbsp; &nbsp; &nbsp; 确认密码不能为空</font>")
                isPsw2 = false;
            }else if(value1!=value2){
                $("#newPassword2+span").html("<font color='red'>&nbsp; &nbsp; &nbsp; 密码与确认密码不一致</font>")
                isPsw2 = false;
            }else {
                $("#newPassword2+span").html("ok");
                isPsw2 = true;
            }
        })
        ...
        $("#change_password").click(function(){
            ...
            $("#newPassword2").trigger("blur");
            $("#oldPassword").trigger("blur");
            $("#update").trigger("submit");
        })

        $("#update").submit(function(){
            return isPsw1&&isPsw2&&isOldPsw;
        });
    })
