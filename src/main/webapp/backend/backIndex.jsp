...
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">H-ui.admin</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V2.3</span>
    ...
    <ul class="Hui-userbar">
        ...
        <li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">
            ...
            <ul class="dropDown-menu radius box-shadow">
                <li><a href="#">个人信息</a></li>
                <li><a href="tourist/index.jsp">商城</a></li>
                <li><a href="common/backLogout">退出</a></li>
            </ul>
        </li>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="back/toBrandList" href="javascript:void(0)">品牌管理</a></li>
                    <li><a _href="backGoods/toProductList" href="javascript:void(0)">系列管理</a></li>
                    <li><a _href="goods/backSearch" href="javascript:void(0)">产品管理</a></li>
                    <li><a _href="order/orderBack" href="javascript:void(0)">订单管理</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a _href="user/userList" href="javascript:void(0)">用户管理</a></li>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active"><span title="我的桌面" data-href="tourist/welcome.html">我的桌面</span><em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="tourist/welcome.html"></iframe>
        </div>
    </div>
</section>
