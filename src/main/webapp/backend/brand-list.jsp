...
<div class="pd-20">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" style="text-decoration: none" onclick="auth_add_user('修改/添加品牌','backend/PopUps/brand-change.jsp','400','400')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 修改品牌</a>
...
<script type="text/javascript">
    $(function(){
        $("#query").click(function(){
            ...
            debugger;
            $("#authorization").load("back/getGoodsByPhoneId",{'phoneId':type});
        })
